      ...
      <section className='mt-5 mb-8 px-3'>
        <div className='mb-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:grid-rows-16 gap-6 md:gap-x-3'>
          ...
          <div className='grid lg:row-start-1 lg:col-start-1 lg:row-span-2 pb-2'>
            <GalleryCard src={gallery.items[7].image.url} alt={gallery.items[7].altText} name={gallery.items[7].name} url={gallery.items[7].link} />
          </div>
          <div className='grid lg:row-start-1 lg:col-start-2 lg:row-span-6'>
            <GalleryCard src={gallery.items[6].image.url} alt={gallery.items[6].altText} name={gallery.items[6].name} url={gallery.items[6].link} />
          </div>
          <div className='grid lg:row-start-1 lg:col-start-3 lg:row-span-6'>
            <GalleryCard src={gallery.items[5].image.url} alt={gallery.items[5].altText} name={gallery.items[5].name} url={gallery.items[5].link} />
          </div>
          <div className='grid lg:row-start-3 lg:col-start-1 lg:row-span-6'>
            <GalleryCard src={gallery.items[4].image.url} alt={gallery.items[4].altText} name={gallery.items[4].name} url={gallery.items[4].link} />
          </div>
          ...
          <div className='grid lg:row-start-8 lg:col-start-2 lg:row-span-6'>
            <GalleryCard src={gallery.items[0].image.url} alt={gallery.items[0].altText} name={gallery.items[0].name} url={gallery.items[0].link} />
          </div>
        </div>
