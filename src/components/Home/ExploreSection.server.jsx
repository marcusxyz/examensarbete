        ...
        <section className="w-full py-8 lg:py-4 border-t border-b border-black">
            ...
            <div className="pb-8 lg:pb-4 px-2 grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="lg:order-first lg:relative">
                    <h3 className="mt-4 lg:mt-0 text-2xl lg:text-3xl xl:text-5xl lg:mb-4">Community renders</h3>
                    <p className="mb-8 lg:text-lg xl:text-2xl">Realistic renders featuring our textures</p>
            ...
            <div className="pt-8 lg:pt-4 border-t border-black">
                ...
                <div className="px-2 lg:flex items-start justify-between lg:mt-4 ">
                    <div>
                        <h3 className="mt-4 lg:mt-0 text-2xl lg:text-3xl xl:text-5xl">Textures that are sensational</h3>
                        <p className="mb-8 lg:mb-0 lg:text-lg xl:text-2xl xl:mt-2">We all believe what our eyes tell us.</p>
                    </div>
            ...
            <div className="mt-8 lg:mt-4 px-2 py-8 lg:py-4 border-y border-black">
                <p className="lg:max-w-[70%] xl:max-w-[50%]">By using a unique setup for texture scanning, we can capture the height and depth of the surface and the very essence of the material. It provides the high-resolution we need to meticulously retouch and tile our textures for both ease of use and high-quality visuals. This is what we mean by textures you can feel. </p>
            </div>
        </section>
    );
}
